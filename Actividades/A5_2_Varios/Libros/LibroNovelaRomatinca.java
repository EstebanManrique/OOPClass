...
public class LibroNovelaRomatinca extends Libro
{
    final static int precio=300;
    public LibroNovelaRomatinca(String autor, String titulo, int anoPublicacion, int edicion, int precio)
    {
